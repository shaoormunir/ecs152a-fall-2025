...
1. Install playwright using: ```pip install playwright``` or ```python3 -m pip install playwright```
2. Install chromium for playwright to use: ```playwright install chromium```
